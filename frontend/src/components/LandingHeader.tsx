...
function IntroParagraph() {
  return (
    <p className="lead mb-4">
      MCD is an automated design recommendation framework that can help you generate performant and realistic designs.
      While this demo focuses on bike designs, MCD is a generic framework that can be configured to handle almost any
      design problem - regardless of the number or nature of constraints or objectives.
    </p>
  );
}
...
function ActionLink(props: { href: string; visibleText: string }) {
  return (
    <div className="row justify-content-center m-1">
      <a href={props.href} className="btn btn-outline-danger btn-lg px-4 gap-3 w-40">
        {props.visibleText}
      </a>
    </div>
  );
